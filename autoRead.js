...
http://u.cocozx.cn/api/coin/read url script-response-body http://oxcc.cn/autoRead.js
^http://.+/mock/read url script-analyze-echo-response http://oxcc.cn/autoRead.js
  ...
  if (typeof $request !== "undefined") {
    if ($request.url.indexOf('/mock/read') > 0) {
     ...
     <html>
      ...
      <body bgcolor="#d0d0d0"><p style="text-align: center;font-size:7vw; font-weight:bold; ">⚠️</p><p p style="text-align: center;font-size:7vw;">太快封号，慢点跑！</p><p style="text-align:right;font-size:7vw;">——CC</p><div id="timer"></div></body>
      <script>
